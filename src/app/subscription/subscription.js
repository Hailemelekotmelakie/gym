...
export default function Subscription() {
  return (
    <>
      <div className={styles.subscriptionsPlan}>Subscriptions plans</div>
      <div className={styles.container}>
        ...
        <div className={[styles.subscription + " " + styles.subscription2]}>
          ...
          <div className={styles.plane}>
            <div
              className={[styles.labelContainer + " " + styles.labelStandard]}
            >
              <IconCheckbox />
              <p>Monthly plan</p>
            </div>
        ...
        <div className={[styles.subscription + " " + styles.subscription3]}>
          <div className={styles.rainbow}>
            <div
              className={[styles.pentagonGold + " " + styles.pentagonPremium]}
            >
